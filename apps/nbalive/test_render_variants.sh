...
for scenario in off_day future scheduled pregame q1 q2 halftime q3 q4 ot double_ot final final_ot delayed postponed cancelled suspended unknown stale timezone_boundary empty worst_case; do
