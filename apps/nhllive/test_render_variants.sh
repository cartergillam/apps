...
for scenario in scheduled pregame live_p1 live_p2 live_p3 intermission overtime shootout final final_ot final_so delayed postponed suspended cancelled stale timezone_boundary future no_games; do
